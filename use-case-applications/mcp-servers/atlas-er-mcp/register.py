"""
Registration script for atlas-er-mcp in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "mcp-servers", "atlas-er-mcp.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    """Register atlas-er-mcp with the Agent Registry."""
    ...
    print(f"Registered atlas-er-mcp: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register atlas-er-mcp")
