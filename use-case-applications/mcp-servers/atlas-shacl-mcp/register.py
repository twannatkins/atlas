"""
Registration script for atlas-shacl-mcp in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "mcp-servers", "atlas-shacl-mcp.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    """Register atlas-shacl-mcp with the Agent Registry."""
    ...
    print(f"Registered atlas-shacl-mcp: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register atlas-shacl-mcp")
