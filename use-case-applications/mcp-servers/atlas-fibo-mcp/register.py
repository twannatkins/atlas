"""
Registration script for atlas-fibo-mcp in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "mcp-servers", "atlas-fibo-mcp.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered atlas-fibo-mcp: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register atlas-fibo-mcp")
