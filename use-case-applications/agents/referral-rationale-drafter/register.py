"""
Registration script for referral-rationale-drafter in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "agents", "referral-rationale-drafter.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered referral-rationale-drafter: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register referral-rationale-drafter")
