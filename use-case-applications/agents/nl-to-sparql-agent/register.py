"""
Registration script for nl-to-sparql-agent in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "agents", "nl-to-sparql-agent.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered nl-to-sparql-agent: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register nl-to-sparql-agent")
