"""
Registration script for referral-orchestrator in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "agents", "referral-orchestrator.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered referral-orchestrator: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register referral-orchestrator")
