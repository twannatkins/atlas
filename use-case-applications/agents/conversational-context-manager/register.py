"""
Registration script for conversational-context-manager in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "agents", "conversational-context-manager.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered conversational-context-manager: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register conversational-context-manager")
