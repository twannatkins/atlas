"""
Registration script for behavioral-signal-agent in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "agents", "behavioral-signal-agent.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered behavioral-signal-agent: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register behavioral-signal-agent")
