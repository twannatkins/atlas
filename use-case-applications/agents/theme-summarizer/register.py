"""
Registration script for theme-summarizer in AWS Agent Registry.
...
SPEC_PATH = os.path.join(
    ...
    "04-aws-agent-registry", "agents", "theme-summarizer.json"
)
...
def register(region: str, endpoint_override: str | None = None) -> dict:
    ...
    print(f"Registered theme-summarizer: {response}")
    return response


def main():
    parser = argparse.ArgumentParser(description="Register theme-summarizer")
